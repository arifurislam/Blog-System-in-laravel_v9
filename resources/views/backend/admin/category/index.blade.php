        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{url('admin/categories/create')}}" class="btn btn-sm btn-primary"><i
