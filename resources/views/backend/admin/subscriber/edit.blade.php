...
<form method="post" action="{{url('admin/posts/'.$post->id)}}" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit Post Informations</h4>
                    <div class="basic-form">
                        ...
                        <div class="form-group">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="img-right">
                                    <img id="imagePreview" src="{{asset('storage/post/'.$post->image)}}"
                                        alt="postImage" class="mt-3 d-block" height="50px">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-0">
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input name="status" type="checkbox" class="form-check-input" {{$post->status == 1 ? 'checked':''}}>Want to
                                    Publish Your post
                                    ???</label>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        ...
                        <a href="{{url('/admin/tags')}}" class="btn btn-sm btn-danger"><i
                    ...
                    <div class="basic-form">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Long Description <span class="text-danger">
                                    *</span></label>
                            <textarea name="body" class="my_summerNote form-control h-150">
                                {!! $post->body !!}
                            </textarea>
                        </div>
                        @if ($errors->has('body'))
