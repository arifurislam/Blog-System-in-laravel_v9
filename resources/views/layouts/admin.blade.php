        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{url('/admin/tags')}}" aria-expanded="false"
                            class="{{Request::is('admin/tags/*') ? 'active':''}}">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Tags</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" class="collapse in">
                            <li class="{{Request::is('admin/posts/*') ? 'active':''}}"><a
                                    href="{{url('/admin/posts')}}">Posts</a></li>
                            <li class="{{Request::is('panding/posts') ? 'active':''}}"><a
                                    href="{{url('/admin/panding/posts')}}">Pending</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{url('admin/subscribers')}}" aria-expanded="false"
                            class="{{Request::is('admin/subscribers/*') ? 'active':''}}">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Subscribers</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('admin/favorites')}}" aria-expanded="false"
                            class="{{Request::is('admin/favorites/*') ? 'active':''}}">
                    ...
                    <li>
                        <a href="{{url('admin/authors')}}" aria-expanded="false"
                            class="{{Request::is('admin/authors/*') ? 'active':''}}">
                            <i class="fa-regular fa-user"></i><span class="nav-text">Authors</span>
                        </a>
                    </li>
